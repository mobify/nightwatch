...
module.exports = function(Nightwatch) {
   ...
   *
   * @link /session/:sessionId/touch/click
   * @param {string} element ID of the element to single tap on.
   * @param {function} [callback] Optional callback function to be called when the command finishes.
   * @api protocol
   */

  Actions.elementIdTap = function(id, callback) {
    var data = {
      element: id
    };
    return postRequest('/touch/click', data, callback);
  };
